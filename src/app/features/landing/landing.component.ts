...
export class LandingComponent implements OnInit {
    ...
    faqs = [
        {
            question: 'ما هي KoraZone365؟',
            answer: 'KoraZone365 هي منصة احترافية لإدارة وتنظيم بطولات كرة القدم، تتيح للاعبين إنشاء فرقهم، التسجيل في البطولات، ومتابعة النتائج والإحصائيات لحظة بلحظة.'
        },
        {
